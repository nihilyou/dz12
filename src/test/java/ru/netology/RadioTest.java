...
class RadioTest {
    ...
    void setSelectStation(String ignoredNameTest, int inputSelectStation, int expectedStation) {
    ...
    void setNextStation(String ignoredNameTest, int oldCurrentStation, int expectedStation) {
        Radio radio = new Radio();
    ...
    void setPrevCurrentStation(String ignoredNameTest, int oldCurrentStation, int expectedStation) {
        Radio radio = new Radio();
        radio.setCurrentStation(oldCurrentStation);
    ...
    void setVolumeUp(String ignoredNameTest, int oldCurrentVolume, int expectedVolume) {
        Radio radio = new Radio();
    ...
    void setVolumeDown(String ignoredNameTest, int oldCurrentVolume, int expectedVolume) {
        Radio radio = new Radio();
        radio.setCurrentVolume(oldCurrentVolume);
        radio.setVolumeDown();
        assertEquals(radio.getCurrentVolume(), expectedVolume);
